...
//! This module implements SHA-224 and SHA-256.
//! It is based on NIST FIPS PUB 180-4, Secure Hash Standard (SHS).
mod hash;
...
/// This is `m` in FIPS PUB 180-4 (Section 2.2.1).
const BLOCK_SIZE: usize = 512;

/// This is `w` in FIPS PUB 180-4 (Section 2.2.1).
const WORD_SIZE: usize = 32;

/// Number of elements in the message schedule `{W_t}` in FIPS PUB 180-4 (Section 6.2.2, step 1).
...
/// See FIPS PUB 180-4, Section 4.2.2.
...
/// See FIPS PUB 180-4, Section 5.3.3.
const H0_256: [u32; 8] =
    [0x6a09e667, 0xbb67ae85, 0x3c6ef372, 0xa54ff53a, 0x510e527f, 0x9b05688c, 0x1f83d9ab, 0x5be0cd19];

/// Initial hash value for SHA-224.
/// See FIPS PUB 180-4, Section 5.3.2.
const H0_224: [u32; 8] =
